...
| File | What it is |
|---|---|
| **[`AGENTS.md`](./AGENTS.md)** | **Start here if you are an AI agent.** Constraints and the rules that must not be broken. |
| [`PitchIn_final_build_spec.md`](./PitchIn_final_build_spec.md) | The current build target: remaining work, verified invariants, acceptance checklist. |
| [`PitchIn_MVP_build_spec.md`](./PitchIn_MVP_build_spec.md) | Reference spec — data model, screens, literal copy, and all seed data. |
| [`PitchIn_logo_spec.md`](./PitchIn_logo_spec.md) | Mark + wordmark brief. |
| [`PitchIn_spec_v1.md`](./PitchIn_spec_v1.md) | The original pitch narrative. Read for tone — it describes no screens. |
| [`NOTES_FOR_NILS.md`](./NOTES_FOR_NILS.md) | Build-agent findings. All resolved in the final spec §2. |
